...
Namespace localhost
    ...
    Partial Public Class WebService1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Attendance_Module.My.MySettings.Default.Attendance_Module_localhost_WebService1
        ...
        Public Function sum(ByVal num1 As Long, ByVal num2 As Long) As String
            Dim results() As Object = Me.Invoke("sum", New Object() {num1, num2})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub sumAsync(ByVal num1 As Long, ByVal num2 As Long)
            Me.sumAsync(num1, num2, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub sumAsync(ByVal num1 As Long, ByVal num2 As Long, ByVal userState As Object)
            If (Me.sumOperationCompleted Is Nothing) Then
                Me.sumOperationCompleted = AddressOf Me.OnsumOperationCompleted
            End If
            Me.InvokeAsync("sum", New Object() {num1, num2}, Me.sumOperationCompleted, userState)
        End Sub
